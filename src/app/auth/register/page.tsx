      ...
      <div className="relative z-10 flex items-center justify-center min-h-screen px-4 py-8">
        ...
        >
          ...
          <div className="text-center mb-8">
            ...
            >
              <Link href="/">
                <div className="h-16 w-16 rounded-2xl bg-gradient-to-r from-amber-500 to-orange-600 flex items-center justify-center mx-auto shadow-lg hover:shadow-xl transition-all duration-300 transform hover:scale-105">
        ...
        <div className="mt-8 space-y-4">
          ...
          <div className="grid grid-cols-3 gap-3">
            <motion.button
              ...
              className="p-3 border border-gray-200 rounded-xl hover:border-amber-300 hover:bg-amber-50 transition-all duration-200 flex items-center justify-center"
