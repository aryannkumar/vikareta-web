    ...
    theme: {
        extend: {
            colors: {
                ...
                // Vikareta brand colors - Orange-Amber Theme
                vikareta: {
                    orange: {
                        50: "#fff7ed",
                        100: "#ffedd5",
                    ...
                    primary: "hsl(var(--vikareta-primary))", // Will be orange
                    secondary: "hsl(var(--vikareta-secondary))", // Will be amber
                    accent: "hsl(var(--vikareta-accent))", // Will be white/light
